...
The three computation types (Type I compression, Type II expansion, Type III rotation), four-tag system, hardness functional, cost formalism, computational blindness, OWF threshold, self-application, and algorithm classification are owned by COMPUTATION.md — a mathematical layer at the same depth as ALGEBRA and OBSERVER. See COMPUTATION for the full characterization theorems C.1–C.10a.
